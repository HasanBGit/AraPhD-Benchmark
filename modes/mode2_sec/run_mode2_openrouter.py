"""
Mode 2 (ArabPhD-sec, Specious Context) evaluation via OpenRouter.

Protocol verified directly against Liu et al. 2025 (CVPR), the paper
ArabPhD-sec mirrors -- read via info/Liu_PhD_A_ChatGPT-Prompted_Visual_
...
script -- modes/mode2_sec/arabphd_test_set_sec.json now carries
...
TEST_SET = HERE / "arabphd_test_set_sec.json"
